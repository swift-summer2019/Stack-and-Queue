//
//  EmployeeStackTableViewController.swift
//  Stack and Queue
//
...
class EmployeeStackTableViewController: UITableViewController {
    ...
    var employees: MyStack<Int>  = MyStack<Int>();
